...
public class TransportEntry implements Serializable {
	public static final Map<Attribute, Substance> EMPTY_MAP = Collections
			.unmodifiableMap(new HashMap<Attribute, Substance>());
	/**
	 * 
	 */
	 ...
	 */
	public TransportEntry(int externalIdentity,
			Map<Attribute, Substance> entryQualifier) {
