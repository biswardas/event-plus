...
import com.biswa.ep.subscription.ProxyChannelContainer;
...
public class ProxyDeploymentHandler extends DeploymentHandler{
	...
	public ConcreteContainer deploy(Container container,Context context,ContainerManager containerManager) {
		ConcreteContainer cs = new ProxyChannelContainer(getQualifiedName(container, context),getProperties(container.getParam()));
